...
public abstract class LightMech implements Mech {
	...
	public LightMech(Head head, CenterTorso centerTorso, Torso leftTorso, Torso rightTorso, Arm leftArm, Arm rightArm, Leg leftLeg, Leg rightLeg){
		this.mechClass = MechClass.LIGHT;
